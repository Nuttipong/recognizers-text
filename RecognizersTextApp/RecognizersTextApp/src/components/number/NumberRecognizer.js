...
class NumberRecognizer extends React.Component {
  ...
  constructor() {
    super();
    Papa.parse("http://localhost:8080/bin/Release/BenchmarkDotNet.Artifacts/results/RecognizersTextApp.NumberRecognizerMeasure-report.csv", 
    {
      config: {
        header: false,
      },
...
function renderX1(x1) {
  ...
  let data = [];
  const methods = ['RecognizeNumber', 'RecognizePercentage', 'RecognizeOrdinal', 'RecognizeNumberRange'];
