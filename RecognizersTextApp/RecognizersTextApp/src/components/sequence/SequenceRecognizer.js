...
class SequenceRecognizer extends React.Component {

  constructor() {
    super();
    Papa.parse("http://localhost:8080/bin/Release/BenchmarkDotNet.Artifacts/results/RecognizersTextApp.SequenceRecognizerMeasure-report.csv", 
    {
      config: {
        header: false,
      },
...
function renderX1(x1) {
  ...
  let data = [];
  const methods = ['RecognizePhoneNumber', 'RecognizeIpAddress', 'RecognizeMention', 'RecognizeHashtag', 'RecognizeEmail', 'RecognizeURL'];
...
export default SequenceRecognizer;
